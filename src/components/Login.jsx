    ...
    >
        <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10`}>
            ...
            <p className='mt-2 text-center text-base text-black/60'>
                ...
                <Link 
                    to="/signup"
                    className='font-n=medium text-primary transition-all duration-200 hover:underline'
                >
                Sign Up
                </Link>
            </p>
               ...
               <div className='space-y-5'>
                 <Input
                   ...
                   {...register("email",{
                    required: true,
                    validate: {
                        matchPattern: (value) => /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/
